<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrPackageEntry.ascx.cs" Inherits="CourierNew.UserControl.CtrPackageEntry" %>
<script src="../UserControl/JS/PackageEntrySearch.js?ver=2"></script>
        ...
        <div class="">
            <div class="border-bottom pt-6 row">
                ...
                <div class="card-title col-lg">
                    <h3 class="card-label">Packing Entry</h3>
                </div>
              <%--  <div class="card-toolbar">
                    
                 <asp:Button runat="server" CssClass="btn btn-primary button-color btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2" ID="btnCatAdd" OnClientClick="return Op(2,0);" Text=" Add Packing" />
                 </div>--%>
