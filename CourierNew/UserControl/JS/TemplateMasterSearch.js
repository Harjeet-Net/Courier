...
function Bind() {
    AddTable();
    var pinTemplateType = $(".ddlTemplateType option:selected").val();

    $('#TableGrid').DataTable({
        ajax:
        {
            url: '/api/Search/Client_SearchTemplateMaster?sTemplateType=' + pinTemplateType,
            dataSrc: '[]',
            colReorder: true
        },
        columns: [{ "data": "Button" },
