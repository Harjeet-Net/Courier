...
{
    public partial class CustomerAddress : ClsPageBase, INweEntryWeb
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (PageType == EnPageType.Parent && iCustomerKey != 0)
                {
                    ...
                    btnTop.Attributes.Add("class", "hidden");
        ...
        public void LoadFormData()
        {
            ...
            {
                /***********Codeing Start*********************/
                objSearch.AddressKey = PagePrimaryKey;
