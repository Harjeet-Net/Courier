...
{
    public partial class LocalShipmentImportExcel : ClsPageBase
    {
        ...
        protected void btnUploadFile_Click(object sender, EventArgs e)
        {
            try
            {
                if (FileUpload1.HasFile)
                {
                    ...
                    {
                        ViewState["ShipmentImportExcel"] = null;
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            ViewState["ShipmentImportExcel"] = dt;
        ...
        protected void RadGridDetail_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                //if (ViewState["ShipmentImportExcel"] != null)
                //{
                //    DataTable dt = (DataTable)ViewState["ShipmentImportExcel"];
                //    if (dt.Rows.Count > 0)
                //    {
                //        RadGridDetail.DataSource = dt;
                //    }
