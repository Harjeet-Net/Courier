<%@ Page Title="Address Entry" Language="C#" MasterPageFile="~/Blank.Master" AutoEventWireup="true" CodeBehind="CustomerAddress.aspx.cs" Inherits="CourierNew.Pages.CustomerAddress" %>
...
<asp:Content ID="C2" ContentPlaceHolderID="CP1" runat="server">
    ...
    <div class="border-bottom p-1 text-right">
        ...
        <TopButton:Buttons runat="server" ID="btnTop" VisibleSave="true" VisibleCancel="true" OnMasterEve="Buttons_MasterEve" enRole="CustomerAddress" />
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="  form-group col-lg-3">
                        <label>Name</label>
                        <asp:TextBox ID="txtCustomerKey" runat="server" Enabled="false" Wrap="False" CssClass=" form-control form-control-solid form-control-lg txtCustomerKey " placeHolder="Customer Name"></asp:TextBox>
